...
import SupportDocumentForm from "@/components/dashboard/support-documents/support-document-form";
import {
  PageHeader,
  PageHeaderContent,
    ...
    <div className="flex min-h-full w-full flex-1 flex-col gap-6">
      <PageHeader>
        <PageHeaderContent>
          ...
          <PageHeaderTitle>Nuevo documento soporte</PageHeaderTitle>
          <PageHeaderDescription>
            &#47;&#47; Crea un documento soporte electrónico
          </PageHeaderDescription>
        </PageHeaderContent>
      </PageHeader>
