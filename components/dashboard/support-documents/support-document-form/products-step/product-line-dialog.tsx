...
import {
  type SupportDocumentItemValues,
  supportDocumentItemSchema,
...
export interface ProductLineDialogProps {
  open: boolean;
  onClose: () => void;
  selectedLine?: { index: number; item: SupportDocumentItemValues } | null;
  existingItems: SupportDocumentItemValues[];
  onAddProduct: (item: SupportDocumentItemValues) => boolean;
  onEditProduct: (item: SupportDocumentItemValues) => boolean;
}
...
const ProductLineDialog: FC<ProductLineDialogProps> = ({
  ...
  const onSubmit: SubmitHandler<AddItemDialogValues> = (values) => {
    ...
    const parsed = supportDocumentItemSchema.safeParse({
  ...
  return (
    ...
    >
      <DialogContent className="sm:max-w-xl">
        ...
        <form
          id="support-doc-product-line-form"
          onSubmit={(event) => {
        ...
        <DialogFooter>
          ...
          <Button
            type="submit"
            form="support-doc-product-line-form"
            disabled={formState.isSubmitting}
          >
