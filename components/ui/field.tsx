...
function FieldGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "group/field-group @container/field-group flex w-full flex-col gap-6 data-[slot=checkbox-group]:gap-3 *:data-[slot=field-group]:gap-5",
        className,
      )}
      {...props}
    />
...
const fieldVariants = cva(
  "data-[invalid=true]:text-destructive group/field flex w-full gap-2.5",
  {
    variants: {
      orientation: {
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "text-muted-foreground/60 text-left text-xs leading-normal font-normal group-has-data-horizontal/field:text-pretty [[data-variant=legend]+&]:-mt-1.5",
